...
const dataabout = {
  ...
  aboutme:
    "My research interests are in Human-Computer Interaction (HCI), specifically at the intersection of Robotics, Mixed Reality (MR), wearables, and AI Agents. I am passionate about leveraging cutting-edge technology to create more intelligent and natural interactive experiences for the future.",
};
const worktimeline = [
  {
