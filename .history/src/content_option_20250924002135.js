...
const dataabout = {
  ...
  aboutme:
    "My research interests are in Human-Computer Interaction (HCI), specifically at the intersection of Robotics, Mixed Reality (MR), wearables, and AI Agents, with hands-on experience building a 6-DOF force-controlled robotic arm. I am passionate about leveraging cutting-edge technology to create more intelligent and natural interactive experiences for the future.",
};
const worktimeline = [
  {
